...
- (void)buttonPressed:(UIButton *)buttonItem {
    ...
    if (self.delegate) {
        if ([self.delegate respondsToSelector:@selector(EEJMenuItemWasPressedWithButton:andTitle:)]) {
            [self.delegate EEJMenuItemWasPressedWithButton:self andTitle:buttonItem.titleLabel.text];
        }
